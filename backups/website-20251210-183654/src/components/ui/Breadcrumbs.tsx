...
export default function Breadcrumbs() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="relative z-40 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <ol className="flex items-center gap-2 flex-wrap text-inherit text-sm md:text-base font-medium rounded-md px-2 py-1">
          <li>
            <Link
              to="/"
              className="text-current hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-sm"
            >
              Home
            </Link>
          </li>
          {crumbs.map((c, idx) => {
            ...
            return (
              <li key={c} className="flex items-center gap-2">
                ...
                {isLast ? (
                  <span className="text-current font-medium">{title}</span>
                ) : (
                  <Link
                    to={to}
                    className="text-current hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-sm"
