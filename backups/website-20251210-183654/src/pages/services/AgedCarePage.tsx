...
const AgedCarePage = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl font-bold mb-6 text-white animate-fade-in-up">Culturally Appropriate Home Care</h1>
            <p className="text-xl text-white/85 leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
      ...
      <section id="programs" className="relative py-20 bg-[#11182e] text-white overflow-hidden">
