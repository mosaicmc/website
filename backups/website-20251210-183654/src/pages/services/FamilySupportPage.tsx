...
const FamilySupportPage = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section
        className="relative py-32 bg-[#11182e] text-white overflow-hidden"
      >
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center rounded-full backdrop-blur-md bg-white/10 border border-white/20 px-6 py-2 text-sm shadow-lg mb-6 animate-fade-in-down">
              <Users className="mr-2 h-4 w-4 text-sun" />
              <span className="text-gray-700 dark:text-white/90 font-medium">Family Support</span>
            </div>
            <h1 className="text-5xl font-bold mb-6 text-white animate-fade-in-up">Every Family Deserves Support That Understands Their Journey</h1>
            <p className="text-xl text-white/80 leading-relaxed mb-8 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
      ...
      <section className="relative py-20 bg-[#11182e] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">Who Can Access Our Services?</h2>
      ...
      <section className="relative py-24 bg-[#11182e] text-white overflow-hidden">
