...
const SettlementSupportPage = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section
        className="hero-theme-sky relative py-32 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 transition-colors duration-300 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden"
      >
      ...
      <section className="relative py-20 bg-background bg-page-gradient transition-colors duration-300 overflow-hidden">
