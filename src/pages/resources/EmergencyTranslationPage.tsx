  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta
          name="description"
          content="Emergency contacts and translation services for multicultural communities. 24/7 interpreter access, crisis support, and urgent help links."
        />
      </Helmet>
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    ...
                    <CardHeader className="px-6 pb-6 pt-0">
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        <Button asChild variant="outline" className="h-11 w-full">
                          <a href="https://www.nsw.gov.au/emergencies" target="_blank" rel="noopener noreferrer" aria-label={`${t('emergency.aria.openNswEmergency')} (opens in new tab)`}>
                      ...
                      <div className="relative z-10 h-full flex flex-col">
                        ...
                        <CardHeader className="p-6 pt-0">
                          {item.action ? (
                            ...
                            <Button asChild variant="outline" className="h-11 w-full">
                              <a href={item.link.href} target="_blank" rel="noopener noreferrer" aria-label={`${t('emergency.aria.openAction', { title: displayTitle })} (opens in new tab)`}>
                                {item.link.label}
                                <ExternalLink className="h-4 w-4 ml-2" />
                              </a>
                            </Button>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    <Button asChild variant="outline" className="w-full md:w-auto h-11">
                      <a href="https://www.tisnational.gov.au/" target="_blank" rel="noopener noreferrer" aria-label={`${t('emergency.aria.visitTis')} (opens in new tab)`} className="inline-flex items-center gap-1">
                        {t('emergency.languageSupport.visitTis')}
                    ...
                    <CardHeader className="p-6 pt-0">
                      <Button asChild variant="outline" className="h-11 w-full">
                        <a
                          ...
                          aria-label={`${t('emergency.aria.openNswEmergency')} (opens in new tab)`}
                        >
                    ...
                    <CardHeader className="p-6 pt-0">
                      <Button asChild variant="outline" className="h-11 w-full">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label={`${t('emergency.aria.openHazards')} (opens in new tab)`}
                        >
                    ...
                    <CardHeader className="p-6 pt-0">
                      <Button asChild variant="outline" className="h-11 w-full">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label={`${t('emergency.aria.openLiveTraffic')} (opens in new tab)`}
                        >
