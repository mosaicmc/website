...
const META_TO_ITEM: Record<PageKey, Omit<RelatedItem, 'key'>> = {
  ...
  locations: { title: 'Locations', description: 'Find our offices.', link: '/contact-us', color: 'leaf', icon: ICONS.map },
  contact: { title: 'Contact', description: 'Talk to our team.', link: '/contact-us', color: 'sky', icon: ICONS.phone },
