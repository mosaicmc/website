...
import { Phone, ArrowRight, CheckCircle, Users, Home, Clock, ShieldCheck, Megaphone, Scale, X, Heart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="service-badge mb-6">
              <Heart className="w-4 h-4 text-care" />
              <span className="font-medium">{t('services.agedCare')}</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              {t('agedCare.hero.headline')}
            </h1>
            <p className="text-base sm:text-xl fluid-p text-gray-700 dark:text-gray-100 leading-relaxed motion-safe:animate-fade-in-up break-words" style={{ animationDelay: '200ms' }}>
              {t('agedCare.hero.subheadline')}
            </p>
            <p className="text-base sm:text-xl fluid-p text-gray-600 dark:text-gray-300 leading-relaxed mb-6 motion-safe:animate-fade-in-up break-words" style={{ animationDelay: '300ms' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center motion-safe:animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              <a
                href="tel:1800813205"
                className="border-2 border-care text-slate-900 dark:text-white hover:bg-care hover:text-slate-900 px-8 py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center hover:scale-105 focus:outline-none focus:ring-2 focus:ring-care focus:ring-offset-2"
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-6">
              <div className="section-badge bg-white/60 dark:bg-white/10 border border-white/40 dark:border-white/20 px-6 py-2 text-sm shadow-lg motion-safe:animate-fade-in-down">
                <span className="me-2 h-2 w-2 rounded-full bg-care animate-pulse"></span>
            ...
            {([
              {
                ...
                features: t('agedCare.programs.sah.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('agedCare.programs.chspIndividual.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('agedCare.programs.chspRespite.features', { returnObjects: true }) as unknown as string[],
