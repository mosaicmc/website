  ...
  const teamMembers = [
    {
      ...
      image: assetPath("/images/SETS Team 128px/SETSTeam_Basim_128px.webp")
    },
    {
      name: "Maram Mohamed",
      role: "Settlement Caseworker",
      ...
      image: assetPath("/images/SETS Team 128px/SETSTeam_Maram_128px.webp")
    },
    {
      ...
      image: assetPath("/images/SETS Team 128px/SETSTeam_Patricia_128px.webp")
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="service-badge mb-6">
              <Home className="w-4 h-4 text-sky" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="service-badge mb-6 motion-safe:animate-fade-in-down">
              ...
              <span className="font-medium">{t('settlement.sections.programs.badge')}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl fluid-h2 font-bold text-gray-900 dark:text-white mb-4 motion-safe:animate-fade-in-up">{t('settlement.sections.programs.title')}</h2>
            ...
            {([
              {
                ...
                features: t('settlement.programs.educationTraining.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.employment.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.healthWellbeing.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.housing.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.languageServices.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.transport.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.civicParticipation.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.familySocialSupport.features', { returnObjects: true }) as unknown as string[],
              ...
              },
              {
                ...
                features: t('settlement.programs.justice.features', { returnObjects: true }) as unknown as string[],
                ...
                >
                  ...
                  <div className="relative z-10 flex w-full items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className={`flex h-12 items-center justify-center overflow-hidden rounded-lg shadow-lg group-hover:shadow-xl transition-all duration-300 ease-out ${service.logo ? "w-20" : `w-12 ${bgClass}`}`}>
                        {service.logo ? (
                          <img
                            src={service.logo}
            ...
            <div className="motion-safe:animate-fade-in-left">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  {(t('settlement.eligibility.items', { returnObjects: true }) as unknown as string[]).map((item, index) => (
      ...
      <section className="py-16 bg-white dark:bg-slate-950 border-y border-slate-100 dark:border-white/5">
        <div className="doc-container">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {(t('settlement.how.steps', { returnObjects: true }) as unknown as { title: string; description: string; bullets: string[] }[]).map((step, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="backdrop-blur-xl bg-white/70 dark:bg-white/10 rounded-2xl p-12 border border-white/50 dark:border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 group motion-safe:animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/contact-us"
                className="border-2 border-sky text-ocean hover:bg-sky hover:text-ocean px-8 py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center hover:scale-105"
              >
