  ...
  const programs = [
    {
      ...
      features: t('family.programs.tei.features', { returnObjects: true }) as unknown as string[],
    ...
    },
    {
      ...
      features: t('family.programs.paw.features', { returnObjects: true }) as unknown as string[],
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center motion-safe:animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              ...
              <a
                ...
                className="border-2 border-sun text-sun dark:text-white hover:bg-sun hover:text-slate-900 px-8 py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center hover:scale-105 focus:outline-none focus:ring-2 focus:ring-sun focus:ring-offset-2"
                aria-label={`${t('family.hero.cta')} (opens in new tab)`}
              >
                {t('family.hero.cta')}
              </a>
            </div>
      ...
      <section className="relative py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              <div className="service-badge mx-auto motion-safe:animate-fade-in-down">
                <span className="me-2 h-2 w-2 rounded-full bg-sun"></span>
                <span className="font-medium">{t('family.sections.programs.badge')}</span>
              </div>
              <h2 className="text-4xl lg:text-5xl fluid-h2 font-bold text-gray-900 dark:text-white mb-4 motion-safe:animate-fade-in-up">{t('family.sections.programs.title')}</h2>
          </div>
            ...
            <div className="motion-safe:animate-fade-in-left">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  {(t('family.eligibility.items', { returnObjects: true }) as unknown as string[]).map((item, index) => (
      ...
      <section className="py-16 bg-white dark:bg-slate-950 border-y border-slate-100 dark:border-white/5">
        <div className="doc-container">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {(t('family.how.steps', { returnObjects: true }) as unknown as { title: string; description: string; bullets: string[] }[]).map((step, idx) => (
        ...
        <section className="py-16 bg-slate-50 dark:bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-10">
              <Link
                to="/company/careers"
                className="inline-flex items-center justify-center rounded-lg bg-sun px-8 py-4 font-semibold text-ocean transition-all duration-300 hover:scale-105 hover:bg-sun/90 hover:shadow-lg hover:shadow-sun/25"
              >
