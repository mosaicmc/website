              ...
              <div className="p-6 relative z-10">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center text-sm text-gray-600 dark:text-white/70">
                    <User className="h-4 w-4 me-2 text-sky" />
                    {t(`storiesPage.items.${story.id}.author`)}
                  </div>
                  <div className="flex items-center text-sm text-gray-600 dark:text-white/70">
                    <Calendar className="h-4 w-4 me-2 text-sky" />
                    {t(`storiesPage.items.${story.id}.date`)}
                  </div>
                  <div className="flex items-center text-sm text-gray-600 dark:text-white/70">
                    <MapPin className="h-4 w-4 me-2 text-sky" />
                    {t(`storiesPage.items.${story.id}.location`)}
                  </div>
                </div>
