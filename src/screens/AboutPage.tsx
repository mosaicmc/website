...
const AboutPage = () => {
  ...
  const boardMembers = React.useMemo(() => [
    { id: "sandra", name: t('aboutPage.board.members.sandra.name'), title: t('aboutPage.board.members.sandra.title'), role: t('aboutPage.board.members.sandra.role'), credentials: t('aboutPage.board.members.sandra.credentials'), summary: t('aboutPage.board.members.sandra.summary'), languages: t('aboutPage.board.members.sandra.languages', { returnObjects: true }) as unknown as string[], bio: t('aboutPage.board.members.sandra.bio'), social: [{ platform: 'linkedin' as const, href: 'https://www.linkedin.com/in/sandra-feltham-2b16a535/' }] },
    { id: "shirley", name: t('aboutPage.board.members.shirley.name'), title: t('aboutPage.board.members.shirley.title'), role: t('aboutPage.board.members.shirley.role'), credentials: t('aboutPage.board.members.shirley.credentials'), summary: t('aboutPage.board.members.shirley.summary'), languages: t('aboutPage.board.members.shirley.languages', { returnObjects: true }) as unknown as string[], bio: t('aboutPage.board.members.shirley.bio'), social: [{ platform: 'linkedin' as const, href: 'https://www.linkedin.com/in/dr-shirley-schulz-robinson-pcc-%F0%9F%87%BA%F0%9F%87%A6-%F0%9F%87%B5%F0%9F%87%B8%F0%9F%87%AE%F0%9F%87%B1-43949938/' }] },
    { id: "zachary", name: t('aboutPage.board.members.zachary.name'), title: t('aboutPage.board.members.zachary.title'), role: t('aboutPage.board.members.zachary.role'), credentials: t('aboutPage.board.members.zachary.credentials'), summary: t('aboutPage.board.members.zachary.summary'), languages: t('aboutPage.board.members.zachary.languages', { returnObjects: true }) as unknown as string[], bio: t('aboutPage.board.members.zachary.bio'), social: [{ platform: 'linkedin' as const, href: '#' }] },
    { id: "raj", name: t('aboutPage.board.members.raj.name'), title: t('aboutPage.board.members.raj.title'), role: t('aboutPage.board.members.raj.role'), credentials: t('aboutPage.board.members.raj.credentials'), summary: t('aboutPage.board.members.raj.summary'), languages: t('aboutPage.board.members.raj.languages', { returnObjects: true }) as unknown as string[], bio: t('aboutPage.board.members.raj.bio'), social: [{ platform: 'linkedin' as const, href: 'https://www.linkedin.com/in/rajsirimanne/' }] },
  ...
  const managementMembers = React.useMemo(() => [
    ...
    },
    {
      ...
      level: 3 as const,
      languages: t('aboutPage.management.members.jawaid.languages', { returnObjects: true }) as unknown as string[],
            ...
            {filteredHistory.map((item, idx) => (
              <div key={idx} className="story-card snap-start min-w-[260px] md:min-w-0 h-full">
                <button
                  ...
                  className="group relative w-full h-full text-start rounded-2xl border border-border bg-background shadow-sm overflow-hidden hover:shadow-md focus:outline-none focus:ring-2 focus:ring-ring transition flex flex-col"
                >
                  {item.image ? (
