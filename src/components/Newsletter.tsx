      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-gray-900">{t('newsletter.title')}</h2>
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              <div className="flex gap-x-4">
                ...
                <MapPin className="h-7 w-6 text-gray-500" aria-hidden="true" />
                </dt>
                <dd>
                  456 Hunter Street
                  <br />
              ...
              <div className="flex gap-x-4">
                ...
                <Phone className="h-7 w-6 text-gray-500" aria-hidden="true" />
                </dt>
                <dd>
              ...
              <div className="flex gap-x-4">
                ...
                <Mail className="h-7 w-6 text-gray-500" aria-hidden="true" />
                </dt>
                <dd>
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:me-0 lg:max-w-lg">
