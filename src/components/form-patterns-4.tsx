...
const Example = () => {
  ...
  return (
    <div className="w-full">
      <Form {...form}>
        <form className="space-y-4 text-start" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-start">{t('contact.form.fields.name')}</FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-start">{t('contact.form.fields.email')}</FormLabel>
                <FormControl>
                  <Input
                    className="bg-background focus-visible:ring-ocean focus-visible:border-ocean focus-visible:ring-offset-2"
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-start">{t('contact.form.fields.service')}</FormLabel>
                  <Select
            ...
            <div className="flex-1">
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-start">{t('contact.form.fields.location')}</FormLabel>
                  <Select
                    defaultValue={field.value}
                    onValueChange={field.onChange}
                  >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-start">{t('contact.form.fields.message')}</FormLabel>
                <FormControl>
                  <Textarea
