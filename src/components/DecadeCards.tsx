        ...
        return (
          ...
          >
            ...
            <div className="mt-4 inline-flex items-center text-sm font-medium text-primary">
              Browse decade
              <span className="ms-1 h-4 w-4 inline-block transition-transform duration-300 group-hover:translate-x-0.5">›</span>
            </div>
          </button>
        );
      })}
