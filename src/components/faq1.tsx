      ...
      <div className="container max-w-3xl">
        ...
        <Accordion type="single" collapsible>
          {items.map((item, index) => (
              ...
              <AccordionTrigger className="font-semibold hover:no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-gray-300 focus-visible:outline-offset-2 focus-visible:rounded-lg">
                {item.question}
              </AccordionTrigger>
              <AccordionContent>
                {item.answer}
