  ...
  return (
    ...
    >
      ...
      {icon && iconPosition === 'left' && (
        <span className="me-2 transition-transform duration-300 group-hover:scale-110">
          {icon}
        </span>
      )}
      ...
      {icon && iconPosition === 'right' && (
        <span className="ms-2 transition-transform duration-300 group-hover:translate-x-1 group-hover:scale-110">
          {icon}
        </span>
      )}
    </button>
