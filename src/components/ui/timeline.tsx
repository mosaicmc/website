    ...
    >
      ...
      {orientation === "vertical" ? (
        <div className="relative max-w-7xl mx-auto pb-6">
          <div
            ref={containerRef}
            className="relative h-[70vh] md:h-[80vh] overflow-y-auto scroll-smooth snap-y snap-mandatory pe-2 [mask-image:linear-gradient(to_bottom,transparent_0%,black_6%,black_94%,transparent_100%)]"
          >
              ...
              {data.map((item, index) => (
                ...
                >
                  <div className="sticky flex flex-col md:flex-row z-40 items-center top-10 md:top-20 self-start max-w-xs lg:max-w-sm md:w-full">
                    ...
                    <h3 className="hidden md:block text-xl md:ps-20 md:text-5xl font-bold text-brand-heading">
                      {item.title}
                    </h3>
                  </div>

                  <div className="relative ps-20 pe-4 md:ps-4 w-full">
                    <h3 className="md:hidden block text-2xl mb-4 text-start font-bold text-brand-heading">
                      {item.title}
                    </h3>
                    <motion.div
