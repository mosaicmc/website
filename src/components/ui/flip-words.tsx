...
export const FlipWords = ({
  ...
  useEffect(() => {
    if (!hasWords || prefersReducedMotion || translationActive) return undefined;
    if (!isAnimating) {
    ...
    return undefined;
  }, [isAnimating, duration, startAnimation, hasWords, prefersReducedMotion, translationActive]);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "z-10 inline-block relative text-start px-1 sm:px-2 py-0 leading-[1.1] min-h-[1.4em] overflow-visible flipwords-gradient",
          className
        )}
        key={currentWord}
      >
