    ...
    <section className="py-20 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Recent projects</h2>
          ...
          <div className="hidden md:flex space-x-4">
            <button
              ...
              className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] p-2 border border-gray-300 dark:border-white/20 rounded-full hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-900 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group cursor-pointer border border-transparent dark:border-slate-800"
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-white/90 dark:bg-white/10 px-3 py-1 rounded-full">
                  <span className="text-sm font-medium text-gray-900 dark:text-white">{project.date}</span>
                </div>
              </div>
              
              <div className="p-8">
                <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-white/70 mb-4">
                ...
                <button className="text-blue-600 hover:text-blue-700 dark:text-sky dark:hover:text-sky/80 font-semibold flex items-center group">
                  Read full story
