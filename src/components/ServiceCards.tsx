  ...
  const services = [
    {
      ...
      features: t('serviceCards.settlement.features', { returnObjects: true }) as unknown as string[],
    ...
    },
    {
      ...
      features: t('serviceCards.agedCare.features', { returnObjects: true }) as unknown as string[],
    ...
    },
    {
      ...
      features: t('serviceCards.familySupport.features', { returnObjects: true }) as unknown as string[],
    ...
    },
    {
      ...
      features: t('serviceCards.communityEngagement.features', { returnObjects: true }) as unknown as string[],
