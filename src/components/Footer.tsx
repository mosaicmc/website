    ...
    <footer className="relative overflow-hidden bg-background text-foreground transition-colors">
      ...
      <div className="border-t border-border bg-background/90 transition-colors">
        <div className="mx-auto max-w-7xl px-6 py-8 sm:py-10 lg:px-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-600 dark:text-muted-foreground">{t('footer.copyright')} · {new Date().getFullYear()}</p>
          <div className="flex flex-wrap items-center gap-3 text-xs text-slate-600 dark:text-muted-foreground">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-600 dark:text-muted-foreground">{t('footer.followUs')}</span>
            <a href="https://au.linkedin.com/company/mosaic-multicultural-connections" target="_blank" rel="noopener noreferrer" aria-label={`${t('footer.aria.linkedin')} (opens in new tab)`} className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] p-2 rounded-full border border-border text-ocean dark:text-sky-text transition hover:bg-sand/50 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background">
            ...
            <a href="https://www.instagram.com/mosaicmc/" target="_blank" rel="noopener noreferrer" aria-label={`${t('footer.aria.instagram')} (opens in new tab)`} className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] p-2 rounded-full border border-border text-ocean dark:text-sky-text transition hover:bg-sand/50 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background">
            ...
            <a href="https://www.facebook.com/mosaicmulticulturalconnections/" target="_blank" rel="noopener noreferrer" aria-label={`${t('footer.aria.facebook')} (opens in new tab)`} className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] p-2 rounded-full border border-border text-ocean dark:text-sky-text transition hover:bg-sand/50 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background">
