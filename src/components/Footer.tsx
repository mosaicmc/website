    ...
    <footer className="relative overflow-hidden bg-white dark:bg-slate-950 text-foreground transition-colors">
      ...
      <div className="border-t border-border bg-white/90 dark:bg-slate-950/90 transition-colors">
        <div className="mx-auto max-w-7xl px-6 py-8 sm:py-10 lg:px-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-700 dark:text-slate-400">{t('footer.copyright')} · {new Date().getFullYear()}</p>
          <div className="flex flex-wrap items-center gap-3 text-xs text-slate-700 dark:text-slate-400">
            ...
            <span className="inline-flex items-center gap-1 rounded-full border border-border px-2 py-1 text-slate-700 dark:text-slate-400">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-600 dark:text-slate-400">{t('footer.followUs')}</span>
