    ...
    <section className="py-20 bg-gray-50 dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Our Action on Poverty programs</h2>
          ...
          {programs.map((program, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-white/90 dark:bg-white/10 p-3 rounded-full">
                  <div className="text-blue-600 dark:text-sky">
                    {program.icon}
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">{program.title}</h3>
                <p className="text-gray-600 dark:text-white/70 leading-relaxed">{program.description}</p>
                
                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10">
                  <button className="text-blue-600 hover:text-blue-700 dark:text-sky dark:hover:text-sky/80 font-medium flex items-center group">
                    Learn more
