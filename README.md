...
This repository hosts the Mosaic Multicultural Connections corporate website built with Next.js (App Router), React, TypeScript, and Tailwind CSS.
...
- `npm run preview`: Start Next.js production server locally (port 4173)
- `npm run lint`: Lint source code
- `npm run i18n:check`: Verify translation keys (usage + duplicate checks)

## Project Structure
```
src/
  app/            # Next.js App Router routes
  screens/        # Page composition components
  components/     # UI components
  locales/        # English copy (translation keys)
