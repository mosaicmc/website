  ...
  theme: {
  	extend: {
  		colors: {
            ...
            'leaf-text': 'var(--leaf-text, #446622)',
            'care-text': 'var(--care-text, #c92a4a)',
            'sun-text': 'var(--sun-text, #b45309)',
  			'text-primary': '#2c3e50',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%': {
  					boxShadow: '0 0 20px rgba(40, 54, 127, 0.4), 0 0 40px rgba(40, 54, 127, 0.2)'
  				},
  				'100%': {
  					boxShadow: '0 0 30px rgba(40, 54, 127, 0.6), 0 0 60px rgba(40, 54, 127, 0.3)'
  				}
  			},
  			glowGentle: {
  				'0%': {
  					boxShadow: '0 0 15px rgba(96, 199, 204, 0.3)'
  				},
  				'100%': {
  					boxShadow: '0 0 25px rgba(96, 199, 204, 0.5)'
  				}
  			},
  			pulseGentle: {
  				'0%, 100%': {
  			...
  			pulseColor: {
  				'0%, 100%': {
  					backgroundColor: 'rgba(40, 54, 127, 0.1)'
  				},
  				'50%': {
  					backgroundColor: 'rgba(96, 199, 204, 0.2)'
  				}
  			},
  			shimmer: {
  				'0%': {
  			...
  			blob: {
  				...
  				'25%': {
  					transform: 'translate(15px, -20px) scale(1.03) rotate(2deg)'
  				},
  				'50%': {
  					transform: 'translate(-10px, 10px) scale(0.97) rotate(-1deg)'
  				},
  				'75%': {
